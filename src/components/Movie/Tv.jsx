        ...
        <div className={styles.info}>
          <div>
            ...
            <div className={styles.data}>
              <span>{Format.formatDate(data.first_air_date)}</span>
              <span>{`${data.number_of_seasons} temporada${
                data.number_of_seasons > 1 ? "s" : ""
              }`}</span>
              <span>
                {`${data.number_of_episodes} episódio${
                  data.number_of_episodes > 1 ? "s" : ""
                }`}
              </span>
            </div>
          </div>
